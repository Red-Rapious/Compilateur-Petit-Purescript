    ...
    let typed_file = {
      ...
      tmain = [
        ...
        TDefn (
          ...
          (*"main", [], TEfunc (
            "log",
            [TAexpr (TEfunc ("show", [TAexpr (TEunop (Uneg, TEatom (TAconst (Cint 42, TInt), TInt), TInt), TInt)], TStr), TStr)],
            TCons ("Effect", [TUnit])
          )*)
          (*"main", [], TEfunc (
            "log",
            [
              TAexpr (
              TEfunc ("show", [TAexpr (
              TEbinop (TEatom (TAconst (Cint (10), TInt), TInt), Bdiv, TEatom (TAconst (Cint (3), TInt), TInt), TInt),
              TInt
              )], TStr), TStr)
            ],
            TCons ("Effect", [TUnit])
          ...
          (*"main", [], TEfunc (
            ...
            [TAexpr (TEfunc ("show", [
              TAexpr (
                (TEfunc ("mod", [TAconst (Cint (-10), TInt); TAconst (Cint (-3), TInt)], TInt)), TInt
              )
            ], TStr), TStr)],
            TCons ("Effect", [TUnit])
          )*)
          (*"main", [], TEdo (
            [
              ...
              TEfunc ("log",
              [TAexpr (TEfunc ("show", [TAconst (Cbool true, TBool)], TStr), TStr)],
              TCons ("Effect", [TUnit])
              )
            ],
            TCons ("Effect", [TUnit])
          ...
          (*"main", [], TEfunc (
            ...
            [
              TAexpr (
              TEfunc ("show", [TAexpr (
              TEbinop (TEatom (TAconst (Cstring "hello", TStr), TStr), Beq, TEatom (TAconst (Cstring "world", TStr), TStr), TBool),
              TBool
              )], TStr), TStr)
            ],
            TCons ("Effect", [TUnit])
          ...
          "main", [], TEfunc (
            ...
            [
              TAexpr (
              TEif (
                TEbinop (TEatom (TAconst (Cstring "world", TStr), TStr), Beq, TEatom (TAconst (Cstring "world", TStr), TStr), TBool),
                TEfunc ("show", [TAconst (Cint 24, TInt)], TStr),
